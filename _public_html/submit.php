...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $username = "u339725174_elan82"; // Replace with your MySQL username
    $password = "ElanProperty@123"; // Replace with your MySQL password
    $dbname = "u339725174_elan"; // Replace with your MySQL database name
